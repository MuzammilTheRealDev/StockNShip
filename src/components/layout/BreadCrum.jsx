        ...
        <section className='bg-neutral flex justify-center py-16 relative'>
            ...
            <div className="z-10">
                ...
                <div className="">
                    ...
                    <div className=" text-lg text-center"> <Link to={'/'} className='text-primary font-bold text-center'><span>Home </span> </Link> {' > '} <span className='font-semibold text-secondary/80'>{title}</span></div>
                </div>
            </div>
        </section>
    )
