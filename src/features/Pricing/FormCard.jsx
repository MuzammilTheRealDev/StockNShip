        ...
        switch (step) {
            case 1:
                return (
                    <>
                        <div className="">
                            <input {...register("name", { required: "Name is required" })} className="input" placeholder="What's your name?*" />
            ...
            case 5:
                return (
                    <div className="text-center space-y-6">
                        ...
                        <button className="bg-primary w-full hover:bg-yellow-500 duration-300 text-white py-2 px-4 rounded-full"> Schedule a Call</button>
                    </div>
                );
            default:
                return null;
            ...
            <form className="flex flex-col gap-4" onSubmit={handleSubmit(onSubmit)}>
                ...
                {step < 5 && (
                    <div className="flex justify-between items-center flex-col gap-3">
                        {step < 4 ? (
                            <button type="button" onClick={nextStep} className="bg-black text-white py-2.5 px-4 rounded-full w-full mt-4">
                                Next
                            </button>
                        ) : (
                ...
                {step < 5 && (
                    <>
                        ...
                        <div className="w-full h-1.5 bg-gray-300 rounded-full overflow-hidden">
                            <div className="h-full bg-black transition-all duration-400" style={{ width: `${(step / 4) * 100}%` }}></div>
                        </div>
